...
namespace QuantConnect.Tests.Engine.DataFeeds
{
    ...
    public class BaseDataCollectionAggregatorReaderTests
    {
        ...
        public void AggregatesDataPerTime(Resolution resolution, int expectedCount, bool useProvidedDate)
        {
            var reader = Initialize(false, resolution, out var dataSource);
            TestBaseDataCollection.UseProvidedDate = useProvidedDate;
        ...
        {
            public static volatile bool UseProvidedDate;
